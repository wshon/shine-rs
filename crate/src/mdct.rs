...
static MDCT_CA0: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.6));
static MDCT_CA1: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.535));
static MDCT_CA2: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.33));
static MDCT_CA3: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.185));
static MDCT_CA4: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.095));
static MDCT_CA5: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.041));
static MDCT_CA6: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.0142));
static MDCT_CA7: LazyLock<i32> = LazyLock::new(|| mdct_ca(-0.0037));

/// Aliasing reduction CS coefficients (matches shine MDCT_CS0-7)
static MDCT_CS0: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.6));
static MDCT_CS1: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.535));
static MDCT_CS2: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.33));
static MDCT_CS3: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.185));
static MDCT_CS4: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.095));
static MDCT_CS5: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.041));
static MDCT_CS6: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.0142));
static MDCT_CS7: LazyLock<i32> = LazyLock::new(|| mdct_cs(-0.0037));
